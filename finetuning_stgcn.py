...
root_dir = '../Dataset/aggregorio_balanced/aggregorio_skeletons_numpy/{}'.format(cluster)
dist_dir = 'stats/stats_new/{}/{}_{}_'.format(cluster, nframes, campionamento)
...
momentum = 0.9
steps = [15,30]
optimizer = optim.SGD(params_to_update, lr=0.5, momentum=momentum, weight_decay=w_decay)
criterion = nn.CrossEntropyLoss()

scheduler = torch.optim.lr_scheduler.MultiStepLR(optimizer, steps, gamma=0.5, last_epoch=-1)
